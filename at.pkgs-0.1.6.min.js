...
return this
},fire:function(){var index;
var handler;
for(index=0;
index<this.handlers.length;
index++){handler=this.handlers[index];
...
source.replace(this.engine.pattern,function(matched,code,escape,raw,offset){var expression;
...
},render:function(_data_){var _this_;
var _text_;
_this_=this;
_text_="";
with(_data_||{}){eval(_this_.code)
}return _text_
}});
return _class_
})(this);
